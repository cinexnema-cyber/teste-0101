  ...
  useEffect(() => {
    const confirmPayment = async () => {
      ...
      try {
        ...
        setError('Erro ao confirmar pagamento. Por favor, entre em contato conosco.');
        setLoading(false);
      }
    };
            ...
            <Card className="bg-xnema-surface border-green-500">
              ...
              <CardContent className="space-y-8">
                    ...
                    {user?.subscriptionPlan && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">
                          {user.subscriptionPlan === 'monthly' ? 'Mensal' : 'Anual'}
                        </span>
                      </div>
                    )}
                    {payment_id && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-white font-mono text-xs">{payment_id}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-white">Agora você tem acesso a:</h3>
                ...
                <div className="bg-xnema-orange/10 border border-xnema-orange/20 rounded-lg p-4">
                  ...
                  <p className="text-gray-400 text-sm">
                    Enviamos uma confirmação para seu email com todos os detalhes da assinatura. 
