...
export default function CreatorPortal() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'published':
        return <Badge className="bg-green-500"><CheckCircle className="w-3 h-3 mr-1" />Publicado</Badge>;
      case 'pending':
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-muted-foreground">Gerencie seu conteúdo, acompanhe receitas e otimize seus resultados</p>
              </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="dashboard" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">3 pendentes de aprovação</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Seus uploads mais recentes e status</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={video.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{video.duration} • {video.uploadDate}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <p className="text-sm font-medium">{video.views.toLocaleString()} views</p>
                            <p className="text-xs text-green-600">R$ {video.revenue.toFixed(2)}</p>
                          </div>
            ...
            <TabsContent value="content" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium">making-of-episodio-2.mp4</span>
                      <span className="text-sm text-muted-foreground">68%</span>
                    </div>
                    <Progress value={68} className="h-2" />
                    <p className="text-xs text-muted-foreground">Processando vídeo... Tempo estimado: 5 minutos</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Gerencie toda sua biblioteca de conteúdo</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <TabsContent value="analytics" className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-2">Analytics Detalhados</h2>
                <p className="text-muted-foreground">Insights profundos sobre seu desempenho</p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Distribuição do seu conteúdo</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64">
                      <ResponsiveContainer width="100%" height="100%">
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Tempo médio assistido</p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="affiliate" className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-2">Sistema de Afiliação</h2>
                <p className="text-muted-foreground">Compartilhe seus links e ganhe comissões</p>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Compartilhe este link para receber comissões de novos assinantes</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Cada novo assinante que se cadastrar através do seu link gera uma comissão de 15% sobre o valor da assinatura.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Use estes botões para compartilhar facilmente</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="payments" className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-2">Dados para Pagamento</h2>
                <p className="text-muted-foreground">Configure suas informações bancárias para receber pagamentos</p>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Dados necessários para transferências e PIX</CardDescription>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setPaymentData({...paymentData, cpfCnpj: e.target.value})}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Select value={paymentData.bankName} onValueChange={(value) => setPaymentData({...paymentData, bankName: value})}>
                          <SelectTrigger>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Prev: 15/03/2024</p>
                      </div>
                      <div className="text-right">
            ...
            <TabsContent value="billing" className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-2">Sistema de Cobrança</h2>
                <p className="text-muted-foreground">Gerencie pagamentos automáticos e mensalidades</p>
              </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Período de carência e próximas cobranças</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-green-600">Período de Carência Ativo</h3>
                          <p className="text-sm text-muted-foreground">{mockAnalytics.graceMonthsLeft} meses restantes</p>
                        </div>
                      </div>
                      <Progress value={((3 - mockAnalytics.graceMonthsLeft) / 3) * 100} className="h-2" />
                      <p className="text-xs text-muted-foreground mt-2">
                    ...
                    <div>
                      <Alert>
                        ...
                        <AlertDescription>
                          Após o período de carência, será cobrada mensalidade de R$ 1.000,00 que pode ser descontada automaticamente da sua receita.
                        </AlertDescription>
                      </Alert>
                    </div>
                  </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Veja como funcionará o desconto automático</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-green-600">R$ {billing.currentRevenue.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Taxa da Plataforma (30%):</span>
                          <span className="text-muted-foreground">R$ {(billing.currentRevenue * 0.3).toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Sua Parte (70%):</span>
                          <span className="font-bold">R$ {(billing.currentRevenue * 0.7).toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-red-500">-R$ {billing.estimatedDeduction.toFixed(2)}</span>
                        </div>
                        <Separator />
                        <div className="flex justify-between">
                          <span className="font-semibold">Valor Final:</span>
                          <span className="font-bold text-green-600">R$ {billing.netRevenue.toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      O desconto automático garante que você nunca precisará fazer transferências manuais. 
                      Se sua receita for menor que R$ 1.000, você só pagará o valor proporcional.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure como prefere pagar a mensalidade</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="p-4 border-2 border-green-500">
                      <div className="text-center">
                        ...
                        <h4 className="font-semibold text-green-600">Desconto Automático</h4>
