...
export default function PricingPage() {
  ...
  const handleSubscribe = async (planId: string) => {
    ...
    try {
      console.log('🛒 Iniciando processo de pagamento:', { planId, userId: user.id });
  ...
  const getPlanFeatures = (planId: string) => {
    ...
    if (planId === 'lifetime') {
      return [...baseFeatures, ...premiumFeatures, 'Acesso vitalício garantido'];
    }
      ...
      <main className="container mx-auto px-4 py-12">
          ...
          {plans.map(plan => (
            <Card 
              ...
              className={`relative hover:shadow-xl transition-shadow ${
                plan.id === getPopularPlan() ? 'border-blue-500 shadow-lg scale-105' : ''
              } ${
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Desfrute de uma experiência cinematográfica com qualidade Ultra HD 4K
            </p>
          </div>
        ...
        {!user && (
          <div className="text-center mt-12 p-8 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
            <h3 className="text-xl font-semibold mb-2">Ainda não tem uma conta?</h3>
