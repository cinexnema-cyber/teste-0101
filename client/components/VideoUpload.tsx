  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Envie seu conteúdo para a plataforma XNEMA. Após o upload, seu vídeo passará por aprovação.
        </CardDescription>
      </CardHeader>
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              ...
              <li>• Criadores em período de carência (3 meses) não pagam comissão</li>
              <li>• Após período de carência: 70% para o criador, 30% para a plataforma</li>
            </ul>
          </AlertDescription>
        </Alert>
      </CardContent>
